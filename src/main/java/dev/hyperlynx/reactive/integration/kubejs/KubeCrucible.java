...
public class KubeCrucible implements CustomJavaToJsWrapper {
    ...
    public Scriptable convertJavaToJs(Context context, Scriptable scriptable, Class<?> aClass) {
        return new NativeJavaCrucible(scriptable, crucible, aClass, context);
    }

    static class NativeJavaCrucible extends NativeJavaObject {
        public NativeJavaCrucible(Scriptable scope, CrucibleBlockEntity crucible, Class<?> aClass, Context cx) {
