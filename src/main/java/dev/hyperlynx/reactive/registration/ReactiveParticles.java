...
public class ReactiveParticles {
    ...
    public static final SimpleParticleType SMALL_BLACK_RUNE = new SimpleParticleType(false);
    ...
    public static final SimpleParticleType ACID_BUBBLE = new SimpleParticleType(false);
