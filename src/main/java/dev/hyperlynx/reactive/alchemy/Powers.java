...
public class Powers {
    ...
    public static final DeferredHolder<Power, Power> CURSE_POWER = POWERS.register("curse", () -> new Power("curse", 0x2D231D, Registration.DUMMY_NOISE_WATER.get(),null));
    ...
    public static final DeferredHolder<Power, Power> X_POWER = POWERS.register("esoteric_x", () -> new Power("esoteric_x", 0x9800FF, Registration.DUMMY_FAST_WATER.get(), null));
    public static final DeferredHolder<Power, Power> Y_POWER = POWERS.register("esoteric_y", () -> new Power("esoteric_y", 0xADEA12, Registration.DUMMY_MAGIC_WATER.get(),null));
    public static final DeferredHolder<Power, Power> Z_POWER = POWERS.register("esoteric_z", () -> new Power("esoteric_z", 0xDACCE8, Registration.DUMMY_NOISE_WATER.get(),null));
    public static final DeferredHolder<Power, Power> FLOW_POWER = POWERS.register("flow", () -> new Power("flow", 0x7A82C4, Registration.DUMMY_FAST_WATER.get(),null));
    ...
    public static final DeferredHolder<Power, Power> ASTRAL_POWER = POWERS.register("astral", () -> new Power("astral", 0xE9D7FA, Registration.DUMMY_MAGIC_WATER.get(),null));
