...
public interface ChainDisplacingBlock {
    ...
    default void breadthFirstDisplace(Level level, BlockPos source, boolean displace_surroundings, int displace_time) {
        ...
        while(!displace_queue.isEmpty()){
            ...
            if(target.equals(source))
                DisplacedBlock.displace(level.getBlockState(target), target, level, displace_time);
            else if(source != null)
