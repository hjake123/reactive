...
public class ReactorEntity extends Entity implements Reactor {
    ...
    protected void defineSynchedData() {
        entityData.define(SYNCED_REACTOR_DATA, new ReactorData(new HashMap<>(), new ArrayList<>()));
        entityData.define(FORCE_GOLD_SYMBOL, false);
        entityData.define(USED_CRYSTAL, false);
        entityData.define(ELECTRIC_CHARGE, 0);
        entityData.define(LIFESPAN, 6000);
    }
    ...
    public ReactionStatusMessage getStatusMessage() {
        return new ReactionStatusMessage(this.getId(), getReactionStatus());
    }
