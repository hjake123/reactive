...
public class Powers {
    ...
    public static final RegistryObject<Power> VITAL_POWER = POWERS.register("vital", () -> new Power("vital", 0xFF0606, (Item) null, Items.RED_DYE));
    ...
    public static final RegistryObject<Power> X_POWER = POWERS.register("esoteric_x", () -> new Power("esoteric_x", 0x9800FF, "Esoteric I", null, Items.MAGENTA_DYE));
    public static final RegistryObject<Power> Y_POWER = POWERS.register("esoteric_y", () -> new Power("esoteric_y", 0xADEA12, "Esoteric II", null, Items.LIME_DYE));
    public static final RegistryObject<Power> Z_POWER = POWERS.register("esoteric_z", () -> new Power("esoteric_z", 0xDACCE8, "Esoteric III", null, Items.GRAY_DYE));
