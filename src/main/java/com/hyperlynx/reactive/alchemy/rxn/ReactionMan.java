...
public class ReactionMan {
    ...
    private HashSet<Reaction> constructReactions(Level l){
        ...
        REACTIONS.add(new AnnihilationReaction(l, "annihilation1v4", BASE_POWER_LIST.get(1), BASE_POWER_LIST.get(4), ReactionEffects::smoke));
        REACTIONS.add(new AnnihilationReaction(l, "annihilation2v5", BASE_POWER_LIST.get(2), BASE_POWER_LIST.get(5), ReactionEffects::formation));
        ...
        REACTIONS.add(new EffectReaction(l, "levitation_effect", ReactionEffects::levitation, 1).setStimulus(Reaction.Stimulus.END_CRYSTAL));
        ...
        switch (order) {
            case 1 -> {
                ...
                REACTIONS.add(new EffectReaction(l, "formation_effect", ReactionEffects::foaming, Powers.Y_POWER.get()).setStimulus(Reaction.Stimulus.GOLD_SYMBOL));
            ...
            case 2 -> {
                ...
                REACTIONS.add(new EffectReaction(l, "formation_effect", ReactionEffects::foaming, Powers.Z_POWER.get()).setStimulus(Reaction.Stimulus.GOLD_SYMBOL));
            ...
            case 3 -> {
                ...
                REACTIONS.add(new EffectReaction(l, "formation_effect", ReactionEffects::foaming, Powers.X_POWER.get()).setStimulus(Reaction.Stimulus.GOLD_SYMBOL));
